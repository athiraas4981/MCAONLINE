...
include('config.php');
$id=$_REQUEST['id'];
$sql=mysql_query("select * from skills where id='$id'") or die(mysql_error());
                                ...
                                <form action="" method="post">
                                    <div class="contact_des">
                                        ...
                                        <div class="inputs_des des_2">
                                            <input type="text" placeholder="Skill " name="skill_name" value="<?php echo $r[2]; ?>"><i class="fa fa-user"></i>
                                        </div>
    
                                        <div class="inputs_des des_2">
                                            <input type="text" placeholder="Skill Percentage" value="<?php echo $r[3]; ?>" name="skill_persc">
                                            <i class="fa fa-envelope-o"></i>
                                        </div>
                                        <div class="inputs_des des_2">
                                            <button type="submit" name="editskill">Edit skill</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
if(isset($_POST['editskill']))	{
	...
	$perc=$_POST['skill_persc'];
	
	$sql=mysql_query("UPDATE skills SET skill_name='$skill',skill_perc='$perc' WHERE id='$id'") or die(mysql_error());
