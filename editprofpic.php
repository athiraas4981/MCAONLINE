                                    ...
                                    <div class="contact_des">
                                        <h4>Add Profile Photo</h4>
                                         <div class="inputs_des des_2">
                                            <?php echo '<img src="data:image/jpeg;base64,'.base64_encode( $r[9] ).'" id="output" width="100" height="129" class="photo"/>'; ?>
                                        ...
                                        <div class="inputs_des des_2">
                                            <button type="submit" name="addskill">Edit Profile pic</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
if(isset($_POST['addskill']))	{
	...
	$sql=mysql_query("UPDATE st_reg SET image='$imagedata' WHERE id='$id'") or die(mysql_error());
