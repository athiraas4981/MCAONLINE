                                ...
                                <form action="" method="post">
                                    <div class="contact_des">
                                        ...
                                        <div class="inputs_des des_2">
                                            <input type="text" placeholder="Skill " name="skill_name"><i class="fa fa-user"></i>
                                        </div>
    
                                        <div class="inputs_des des_2">
                                            <input type="text" placeholder="Skill Percentage" name="skill_persc">
                                            <i class="fa fa-envelope-o"></i>
                                        </div>
                                        <div class="inputs_des des_2">
                                            <button type="submit" name="addskill">Add skill</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
if(isset($_POST['addskill']))	{
	...
	$sql=mysql_query("INSERT INTO skills (st_id,skill_name,skill_perc) VALUES ('$st_id','$skill','$perc')") or die(mysql_error());
}
?>
