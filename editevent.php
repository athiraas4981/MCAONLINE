                                    ...
                                    <div class="contact_des">
                                        <h4>Edit Event</h4>
                                         <div class="inputs_des des_2">
                                           <input type="text" name="event" placeholder="Event Name" value="<?php echo $row[1]; ?>"><i class="fa fa-user"></i>
                                        </div>
                                        
                                        <div class="inputs_des des_2">
                                            <textarea name="content" placeholder="Event description"><?php echo $row[2]; ?></textarea><i class="fa fa-mail-forward"></i>
                                        </div>
                                        
                                        <div class="inputs_des des_2">
                                            <input type="text" name="TIME" placeholder="Event Time" value="<?php echo $row[4]; ?>"><i class="fa fa-mail-forward"></i>
                                        </div>
                                        
                                         <div class="inputs_des des_2">
                                            <input type="date" name="DATE" placeholder="Event Date" value="<?php echo $row[5]; ?>"><i class="fa fa-mail-forward"></i>
                                        </div>
                                        
                                        <div class="inputs_des des_2">
                                            <input type="text" name="VENUE" placeholder="Event Venue" value="<?php echo $row[6]; ?>"><i class="fa fa-mail-forward"></i>
                                        </div>
                                        
                                        <div class="inputs_des des_2">
                                            <input type="text" name="COLLEGE" placeholder="Event College" value="<?php echo $row[7]; ?>"><i class="fa fa-mail-forward"></i>
                                        </div>
                                        
                                        <div class="inputs_des des_2">
                                            <input type="text" name="PASS" placeholder="Event Reg fee" value="<?php echo $row[8]; ?>"><i class="fa fa-mail-forward"></i>
                                        </div>
                                        ...
                                        <div class="inputs_des des_2">
   										...
   										<div class="inputs_des des_2">
                                            <button type="submit" name="addskill">Edit Event</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
	...
	if ($_FILES['fileToUpload']['tmp_name'] == "")
{
	...
	$sql1=mysql_query("UPDATE event SET event_name='$name',content=$content',time='$time',date='$date',venue='$venue',college='$college',pass='$PASS'  WHERE id='$id'");
	
}else{
	
	$fileToUpload=addslashes(file_get_contents($_FILES["fileToUpload"]["tmp_name"]));
	
	$sql1=mysql_query("UPDATE event SET event_name='$name',content=$content',image='$fileToUpload',time='$time',date='$date',venue='$venue',college='$college',pass='$PASS'  WHERE id='$id'");
