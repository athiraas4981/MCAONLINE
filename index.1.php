...
if(isset($_POST['submit']))
{
	...
	$sql="INSERT INTO registration(Name,Email,Password,Phone_number,college_name,Admission_no,year_of_study) Values('$v1','$v2','$v3','$v4','$v5','$v6','$v7')";
	mysql_query($sql) OR die(mysql_error());
	
	 $maxval=mysql_query("SELECT MAX(id) FROM registration");
	$val=mysql_fetch_array($maxval);
	$max=$val[0];
	mysql_query("INSERT INTO login1(st_id,username,password,user_type) Values('$max','$v2','$v3','student')");
...
if(isset($_POST['signin'])){
	$s1=$_POST['mail'];
    $s2=$_POST['pass'];
$sql="SELECT * FROM registration WHERE email='$s1' AND password='$s2'";
...
-->
		...
		<div class="edu2_main_bn_wrap">
			<div id="owl-demo-main" class="owl-carousel owl-theme">
				<div class="item">
					<figure>
						<img src="masonry_thumb3.jpg" alt=""/>
						<figcaption>copy1
