...
include('config.php');
$id=$_REQUEST['id'];
$sql="SELECT * FROM bookes WHERE id='$id'";
	    			...
	    			<div class="row">
	    				...
	    				<div class="col-md-7">
    						...
    						<ul class="login_wrap">
    							...
    							<li><a href="viewnote.php"Notes</a></li>
    						</ul>	    					
	    					<ul class="top_nav">
                                    ...
                                    <div class="contact_des">
                                        <h4>Edit Books</h4>
                                         <div class="inputs_des des_2">
                                           <input type="text" name="book_name" value="<?php echo $row[2]; ?>" placeholder="Book Name"><i class="fa fa-user"></i>
                                        </div>
                                        
                                        <div class="inputs_des des_2">
                                            <textarea name="book_desc" placeholder="Book description"><?php echo $row[3]; ?></textarea><i class="fa fa-mail-forward"></i>
                                        </div>
                                        
                                        <div class="inputs_des des_2">
                                            <input type="text" name="price" placeholder="Book Price" value="<?php echo $row[4]; ?>"><i class="fa fa-mail-forward"></i>
                                        </div>
                                        ...
                                        <div class="inputs_des des_2">
   										...
   										<div class="inputs_des des_2">
                                            <button type="submit" name="addskill">Edit Books</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
if ($_FILES['fileToUpload']['tmp_name'] == "")
{
	...
	$sql1=mysql_query("UPDATE bookes SET book_name='$name',Book_content='$content',price='$price' WHERE id='$id'");
	
}else{
	
	$img=addslashes(file_get_contents($_FILES['fileToUpload']['tmp_name']));
	
	$sql1=mysql_query("UPDATE bookes SET book_name='$name',Book_content='$content',price='$price',image='$img' WHERE id='$id'");
	
}


	
//$v="insert into bookes (book_name,Book_content,price,image) values('$name','$content','$price','$img')" ;
