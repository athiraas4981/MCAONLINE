...
<!-- Mirrored from kodeforest.net/html/uoe/our-courses.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 29 Sep 2018 08:45:32 GMT -->
<head>
	<meta charset="utf-8">
	    			...
	    			<div class="row">
	    				...
	    				<div class="col-md-7">
	    					...
	    					<ul class="top_nav">
	    						...
	    						<li><a href="our-courses.php">Giving</a></li>
    					...
    					<div class="col-md-10">
    						...
    						<div class="nav_2" id="navigation">
    							<ul>
		                            ...
		                            <li><a href="#">Books</a>
		                            	<ul>
		                                	<li><a href="our-courses.php">bookes and notes</a></li>
		                                </ul>
		                            </li>
		                            <li><a href="#">Teacher</a>
		                            	<ul>
					            ...
					            <div id="kode-responsive-navigation" class="dl-menuwrapper">
					                ...
					                <ul class="dl-menu">
					                    ...
					                    <li class="menu-item kode-parent-menu"><a href="our-blog.php">Blog</a>
					                    ...
					                    <li class="menu-item kode-parent-menu"><a href="gallery-masonary.php">Gallery</a>
					                        
					                    </li>
					                  
					                    <li class="menu-item kode-parent-menu"><a href="Contact Us.php">Contact US</a>
		    			...
		    			<form>
		    				<div class="search_bar_des">
		    					...
		    					<select id="basic">
                                    ...
                                    <option value="9">sem 2</option>
                                    <option value="2">sem 3</option>
                                    <option value="3">sem 4</option>
                                    <option value="6">sem 5</option>
                                    <option value="8">sem 6</option>
                                </select>
		    				</div>
			...
			?>
	 					...
	 					<div class="col-md-4 col-sm-6">
	 						...
	 						<div class="edu2_col_3_wrap">
	 							<figure>
	 								<?php echo '<img src="data:image/jpeg;base64,'.base64_encode($row[5]).'" width="30px" height="200px" />'; ?>
	 							...
	 							<div class="edu2_col_3_des">
	 								...
	 								<div class="video_link_wrap">
	 									...
	 									<span><sup>Rs.</sup><?php echo $row[4]; ?></span>
	 								</div>
                                    
                                    <?php
	
	$sql1="SELECT * FROM st_reg WHERE id='$stid' ";
		...
		while($row1=mysql_fetch_array($qry1)){
			?>
		 							...
		 							<div class="edu2_col_3_ftr">
		 								<figure>
                                        <?php echo '<img src="data:image/jpeg;base64,'.base64_encode($row1[9]).'" />'; ?>
                                        <!--<img src="extra-images/col_3_des1.jpg" alt=""/>--></figure>
		 								<a href="#"><?php echo $row1[1]; ?></a>
                                        <a href="#"><?php echo $row1[4]; ?></a>
		 								<div class="rating">
											<span>☆</span>
											<span>☆</span>
											<span>☆</span>
...
<!-- Mirrored from kodeforest.net/html/uoe/our-courses.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 29 Sep 2018 08:46:07 GMT -->
</html>
