...
<div class="wrap">
  ...
  <div class="container">
    <aside>
     <h3>Categories</h3>
      <ul class="categories">
		...
		<li><span><a href="#" style="color:#FF4500">Upload Notes</a></span></li>
	...
	<tr>
	<td colspan="2" align="center" ><input type="submit" name="submit" value="upload" style="background-color: darkgrey;color: white;width:100px;height:40px;"></td>
	</tr>	
</table>
</form>
 <?php
if(isset($_POST['submit']))
{
	...
	$sql="insert into upload(book_name,book_content,image)Values('$v1','$v2','$v3')";
	/*echo $sql;*/
