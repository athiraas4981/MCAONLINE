...
<?php
	...
	$sql="SELECT * FROM event WHERE st_id='$st_id'";
	...
	if($rw>0){
		...
		while($row=mysql_fetch_array($qry)){
			...
			<tr>
				...
				<td><a href="editevent.php?id=<?php echo $row[0];?>"><button>Edit</button></a> &nbsp;&nbsp;&nbsp;&nbsp;  <a href="deleteevent.php?id=<?php echo $row[0];?>"><button>Delete</button></a></td>
			</tr>
