...
<!-- Mirrored from kodeforest.net/html/uoe/our-event.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 29 Sep 2018 08:46:18 GMT -->
<head>
	<meta charset="utf-8">
	...
	if($rw>0){
		...
		while($row=mysql_fetch_array($qry)){
			...
			?>
						...
						<a href="registerevents.php" class="readmore">Register<i class="fa fa-long-arrow-right"></i></a>
									
								</div>
									
								<figure> <?php echo '<img src="data:image/jpeg;base64,'.base64_encode($row[3]).'" />'; ?>
                                <!--
                                <img src="extra-images/event1.jpg" alt=""/>
...
<!-- Mirrored from kodeforest.net/html/uoe/our-event.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 29 Sep 2018 08:46:34 GMT -->
</html>
