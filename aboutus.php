...
<!-- Mirrored from kodeforest.net/html/uoe/aboutus.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 29 Sep 2018 08:46:07 GMT -->
<head>
	<meta charset="utf-8">
    				...
    				<div class="row">
    					<div class="col-md-6">
    						<div class="abt_univ_wrap">
								...
								<div class="abt_univ_des">
									...
									<span>
									 It is  a social media network site only for MCA students. This site will help students to communicate with other batches and colleges. They can share there notes text books, syllabus. Every one can share their query. So some one can easily teach about the topic. And can add video tutorials or pdf to query. Every one this social media can easily get the result, when the result is published they can share college cultural fest and seminars to this so that we can register through this site and participate to the events. And also buying and selling of available books from and to students.  
</span>
    					...
    					<div class="col-md-6">
    						<div class="abt_univ_thumb">
    							<figure>
    								<img src="extra-images/std3.jpg" alt=""/>
    							</figure>
    						</div>
    					</div>
							...
							<div class="col-md-3 col-sm-6">
								...
								<div class="kf_intro_des">
									<div class="kf_intro_des_caption">
										...
										<p>
 In Latin and Greek, the idea of a bookcase is represented by Bibliotheca and Bibliothēkē (Greek: βιβλιοθήκη): derivatives of these mean library in many modern languages, e.g. French bibliothèque</p>
										<a href="#">view more</a>
									</div>
								</div>
								<!-- INTERO DES END-->
							...
							<div class="col-md-3 col-sm-6">
								...
								<div class="kf_intro_des">
									<div class="kf_intro_des_caption">
										...
										<p>There are two steps to becoming an Instructor. Take the Instructor Training course. The training course runs over two full days and covers the basics of educational psychology, instructional design, and how to apply both to teaching workshops for The Carpentries</p>
										<a href="#">view more</a>
									</div>
								</div>
								<!-- INTERO DES END-->
							...
							<div class="col-md-3 col-sm-6">
								...
								<div class="kf_intro_des">
									<div class="kf_intro_des_caption">
										...
										<p>The only way to effectively manage social media at scale is with the use of social media management tools that can improve your efficiency..</p>
										<a href="#">view more</a>
									</div>
								</div>
								<!-- INTERO DES END-->
								...
								<ul class="bxslider">
									<li>
										...
										<div class="student_slider_des">
											...
											<!-- HEADING 1 END-->
											<p>
   This site provide capabilities for registering students for partcipating events held by various colleges; and can share useful notes of various colleges. we can communicate with other college students under KTU university. This is very useful to us. </p>
									...
									<li>
										...
										<div class="student_slider_des">
											...
											<!-- HEADING 1 END-->
											<p>Something that I've come to appreciate about College is its commitment to high academic achievement while also encouraging students to get involved in.</p>
											<div class="std_name_des">
						...
						<div class="edu2_faculty_wrap">
							<div id="owl-demo-8" class="owl-carousel owl-theme">
								<div class="item">
									...
									<div class="edu2_faculty_des">
										...
										<div class="edu2_faculty_des2">
											<h6><a href="#">SELMA JOSEPH A</a></h6>
											<strong>Head Of The Department <br>
											LMCST</strong>
											<p>LOURDES MATHA COLLEGE OF SCIENCE AND TECHNOLOGY KUTTICHAL,TVM</p>
										</div>
									</div>
									<!-- FACULTY DES END-->
								</div>
								...
								<div class="item">
									<!-- FACULTY DES START-->
									<div class="edu2_faculty_des">
										<figure><img src="extra-images/JOSE T JOSEPH.jpg" alt=""/>
											<figcaption>
												<a href="#"><i class="fa fa-facebook"></i></a>
												<a href="#"><i class="fa fa-twitter"></i></a>
												<a href="#"><i class="fa fa-linkedin"></i></a>
										...
										<div class="edu2_faculty_des2">
											<h6><a href="#">JOSE T JOSEPH</a></h6>
											<strong>Head Of The Department <br>
											CET</strong>
											<p>COLLEGRE OF ENGINEERING TRIVANDRUM</p>
										</div>
									</div>
									<!-- FACULTY DES END-->
								</div>
								...
								<div class="item">
									<!-- FACULTY DES START-->
									<div class="edu2_faculty_des">
										<figure><img src="extra-images/MCA305-1415842871-thumb.jpg" alt=""/>
											<figcaption>
												<a href="#"><i class="fa fa-facebook"></i></a>
												<a href="#"><i class="fa fa-twitter"></i></a>
												<a href="#"><i class="fa fa-linkedin"></i></a>
										...
										<div class="edu2_faculty_des2">
											<h6><a href="#">NADERA BEEVI S</a></h6>
											<strong>Head Of The Department <br>
											TKM</strong>
											<p>THANGAL KUNJU MUSALIAR COLLEGE OF ENGINEERING KOLLAM</p>
										</div>
									</div>
									<!-- FACULTY DES END-->
								</div>
...
<!-- Mirrored from kodeforest.net/html/uoe/aboutus.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 29 Sep 2018 08:46:16 GMT -->
</html>
