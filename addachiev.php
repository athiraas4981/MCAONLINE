                                    ...
                                    <div class="contact_des">
                                        <h4>Add Skills</h4>
                                         <div class="inputs_des des_2">
                                            <input type="date" placeholder="Skill " name="achieve_date"></i>
                                        </div>
                                        
                                        <div class="inputs_des des_2">
                                            <input type="text" placeholder="Achievement " name="achieve_name"><i class="fa fa-user"></i>
                                        </div>
   										<div class="inputs_des des_2">
                                            <input type="text" placeholder="Achievement type" name="achieve_type"><i class="fa fa-user"></i>
                                        </div>
                                        <div class="inputs_des des_2">
                                           <textarea name="achieve_desc"></textarea>
                                            <i class="fa fa-envelope-o"></i>
                                        </div>
                                        <div class="inputs_des des_2">
                                            <button type="submit" name="addskill">Add Achievements</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
if(isset($_POST['addskill']))	{
	...
	$sql=mysql_query("INSERT INTO achievements (st_id,date_achievement,achievemnt,achievement_type,achievement_desc) VALUES ('$st_id','$date_achieve_format','$achieve','$achieve_type','$achieve_desc')") or die(mysql_error());
}
?>
