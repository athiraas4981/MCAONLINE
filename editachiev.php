...
include('config.php');
$id=$_REQUEST['id'];
$sql=mysql_query("select * from achievements where id='$id'") or die(mysql_error());
                                    ...
                                    <div class="contact_des">
                                        <h4>Edit Achievements</h4>
                                         <div class="inputs_des des_2">
                                            <input type="date" placeholder="Skill " value="<?php echo strftime('%m/%d/%Y', strtotime($r[2])); ?>" name="achieve_date"></i>
                                        </div>
                                        
                                        <div class="inputs_des des_2">
                                            <input type="text" placeholder="Achievement " value="<?php echo $r[3]; ?>" name="achieve_name"><i class="fa fa-user"></i>
                                        </div>
   										<div class="inputs_des des_2">
                                            <input type="text" placeholder="Achievement type" value="<?php echo $r[4]; ?>" name="achieve_type"><i class="fa fa-user"></i>
                                        </div>
                                        <div class="inputs_des des_2">
                                           <textarea name="achieve_desc"><?php echo $r[5]; ?></textarea>
                                            <i class="fa fa-envelope-o"></i>
                                        </div>
                                        <div class="inputs_des des_2">
                                            <button type="submit" name="addskill">Edit Achievements</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
if(isset($_POST['addskill']))	{
	...
	$date_achieve=$_POST['achieve_date'];
	$date_achieve_str=strtotime($date_achieve);
	$date_achieve_format = date('d M Y', $date_achieve_str);
	$achieve=$_POST['achieve_name'];
	$achieve_type=$_POST['achieve_type'];
	$achieve_desc=$_POST['achieve_desc'];
	
	$sql=mysql_query("UPDATE achievements SET date_achievement='$date_achieve_format',achievemnt='$achieve',achievement_type='$achieve_type',achievement_desc='$achieve_desc' WHERE id='$id'") or die(mysql_error());
