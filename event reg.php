                                    ...
                                    <div class="contact_des">
                                        <h4>Event Reg</h4>
                                         <div class="inputs_des des_2">
                                           <input type="text" name="name" placeholder="Student Name"><i class="fa fa-user"></i>
                                        </div>
                                        
                                        <div class="inputs_des des_2">
                                            <input type="text" name="addmsno" placeholder="Addmission Number"><i class="fa fa-mail-forward"></i>
                                        </div>
                                        
                                        <div class="inputs_des des_2">
                                            <input type="text" name="collegename" placeholder="College Name"><i class="fa fa-mail-forward"></i>
                                        </div>
                                        
                                         <div class="inputs_des des_2">
                                            <input type="text" name="ename" placeholder="Event Name"><i class="fa fa-mail-forward"></i>
                                        </div>
                                        
                                        <div class="inputs_des des_2">
                                            <button type="submit" name="addskill">REGISTER</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
$name=$_POST['name'];
$addmsnno=$_POST['addmsno'];
$collegename=$_POST['collegename'];
$eventname=$_POST['ename'];
//$fileToUpload=$_POST['fileToUpload'];

$v="insert into regevents(name,addmission_no,college_name,event_name) values('$name','$addmsnno','$collegename','$eventname')" ;
